...
public class TuikexinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public TuikexinxiEntity() {
		
	}
	
	public TuikexinxiEntity(T t) {
		try {
	 ...
	 * 设置：选课日期
	 */
	public void setXuankeriqi(String xuankeriqi) {
		this.xuankeriqi = xuankeriqi;
	}
	/**
	 * 获取：选课日期
	 */
	public String getXuankeriqi() {
		return xuankeriqi;
	}
	/**
	 * 设置：退课说明
