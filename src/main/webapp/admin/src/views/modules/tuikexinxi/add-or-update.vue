          ...
          <el-form-item class="input" label="学期" prop="xueqi">
              <el-input v-model="ruleForm.xueqi" 
                placeholder="学期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="选课日期" prop="xuankeriqi">
          <el-input v-model="ruleForm.xuankeriqi" 
              placeholder="选课日期" clearable  :readonly="ro.xuankeriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="选课日期" prop="xuankeriqi">
              <el-input v-model="ruleForm.xuankeriqi" 
                placeholder="选课日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="退课说明" prop="tuikeshuoming">
          <el-input v-model="ruleForm.tuikeshuoming" 
              placeholder="退课说明" clearable  :readonly="ro.tuikeshuoming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="退课说明" prop="tuikeshuoming">
              <el-input v-model="ruleForm.tuikeshuoming" 
                placeholder="退课说明" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="退课日期" prop="tuikeriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.tuikeriqi" 
                type="date"
                placeholder="退课日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tuikeriqi" label="退课日期" prop="tuikeriqi">
              <el-input v-model="ruleForm.tuikeriqi" 
                placeholder="退课日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueqi = true;
            continue;
	            	            ...
	            	            if(o=='xuankeriqi'){
            this.ruleForm.xuankeriqi = obj[o];
	    this.ro.xuankeriqi = true;
            continue;
          }
	            	            if(o=='tuikeshuoming'){
            this.ruleForm.tuikeshuoming = obj[o];
	    this.ro.tuikeshuoming = true;
            continue;
          }
	            	            if(o=='tuikeriqi'){
            this.ruleForm.tuikeriqi = obj[o];
	    this.ro.tuikeriqi = true;
            continue;
          }
	            	            if(o=='jiaoshigonghao'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `tuikexinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tuikexinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
