          ...
          <el-form-item class="input" label="学期" prop="xueqi">
              <el-input v-model="ruleForm.xueqi" 
                placeholder="学期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="选课日期" prop="xuankeriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.xuankeriqi" 
                type="date"
                placeholder="选课日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xuankeriqi" label="选课日期" prop="xuankeriqi">
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                    ...
                                                                                                                                    this.zhuangtaiOptions = "正常,已退课".split(',')
                                                                                                                                                          },
                                                                                                                // 多级联动参数
                                                                                                                                              info(id) {
      this.$http({
